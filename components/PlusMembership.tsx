...
const defaultContent = {
    ...
    intro: {
        heading: "Experience Premium Healthcare",
        subheading: "The Kingzy Platinum Cluster is an exclusive membership designed for individuals and healthcare providers who demand nothing but the best. We combine smart technology with white-glove service to manage your health needs with unprecedented efficiency."
    },
    benefits: [
    ...
    cta: {
        heading: "Elevate Your Health Journey",
        subheading: "Join the elite circle of Kingzy partners and enjoy benefits tailored for the modern healthcare professional.",
        buttonText: "JOIN THE PLATINUM CLUSTER"
    },
    partners: {
        heading: "Trusted by Premium Clinics Worldwide",
        logos: [
...
const PlusMembership: React.FC<PlusMembershipProps> = ({ onNavigate }) => {
    ...
    useEffect(() => {
        ...
        if (cmsDataRaw) {
            ...
            if (cmsData.plusMembershipPage) {
                setContent(cmsData.plusMembershipPage);
            }
        }
    }, []);
        ...
        <div className="bg-white">
            ...
            <div className="container mx-auto px-4 py-16">
                <div className="max-w-4xl mx-auto text-center mb-16">
                    <h2 className="text-4xl font-bold text-brand-dark mb-6">{content.intro.heading}</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    {content.benefits.map((benefit, index) => {
                        const Icon = iconMap[benefit.icon] || ShieldCheckIcon;
                        return (
                ...
                <div className="bg-brand-dark rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden">
                    <div className="relative z-10">
                        <h2 className="text-3xl md:text-5xl font-bold mb-6 italic">{content.cta.heading}</h2>
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4 text-center">
                    <h2 className="text-2xl font-bold text-brand-dark mb-8 uppercase tracking-widest opacity-80">{content.partners.heading}</h2>
