            ...
            <div className="container mx-auto px-4 py-16 text-center">
                 <div className="max-w-2xl mx-auto">
                    ...
                    <p className="text-gray-600 text-lg">
                        We are putting the finishing touches on our Platinum Cluster membership program. Get ready for an enhanced experience with benefits designed to save you time and money on your healthcare needs. Stay tuned for the official launch!
                    </p>
                </div>
            </div>
        </div>
